      ...
      >
        <div className="flex items-center gap-1.5 mb-2">
          <div className="w-4 h-4 rounded-lg bg-[rgba(156,74,41,0.15)] flex items-center justify-center">
            <Sparkles size={8} className="text-[#273B3A]" />
          </div>
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-[#E6D4C7]/80 backdrop-blur-2xl shadow-[0_1px_0_0_rgba(255,255,255,0.04)]"
          : "bg-transparent"
      }`}
    >
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#E6D4C7]/98 backdrop-blur-2xl border-t border-[#C9BAB0] px-6 pb-8 pt-6 space-y-5">
          ...
          <div className="flex items-center gap-5 pt-3">
            ...
            <Link
              href="/signup"
              className="text-sm font-medium px-6 py-2.5 rounded-full bg-[#273B3A] text-[#E6D4C7]"
            >
              Start Free Trial
            </Link>
          </div>
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-[72px] overflow-hidden bg-[#E6D4C7]">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center py-20">
        <Reveal>
          <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-[rgba(156,74,41,0.15)]/60 text-[#273B3A] text-sm font-medium mb-10 border border-[#273B3A]/15 backdrop-blur-sm">
            <Sparkles size={14} />
...
function ProblemSolution() {
  ...
  return (
    <section className="py-28 sm:py-36 bg-[#E6D4C7]">
...
function Comparison() {
  ...
  return (
    <section className="py-28 sm:py-36 bg-[#E6D4C7]" id="compare">
                  ...
                  <tr className="border-b border-[#C9BAB0]">
                    ...
                    <th className="p-5 text-sm font-semibold text-[#273B3A] text-center">
                      <div className="flex flex-col items-center gap-1.5">
                        <div className="w-7 h-7 rounded-md bg-[#273B3A] flex items-center justify-center text-xs font-bold text-[#E6D4C7]">
                          A
                        </div>
                        Atlas
                      </div>
        ...
        <div className="grid md:grid-cols-3 gap-5 max-w-4xl mx-auto">
          {plans.map((plan, i) => (
            <Reveal key={plan.name} delay={i * 120}>
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-5 py-1.5 bg-[#273B3A] text-[#E6D4C7] text-xs font-bold rounded-full tracking-wide uppercase">
                    Most Popular
                  </div>
                )}
...
function Testimonials() {
  return (
    <section className="py-28 sm:py-36 bg-[#E6D4C7]" id="testimonials">
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <div className="text-center max-w-2xl mx-auto mb-20">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#1A2726]">
                ...
                <div className="flex gap-1 mb-6">
                  {Array.from({ length: t.rating }).map((_, j) => (
                    <Star
                      key={j}
                      size={14}
                      className="fill-[#273B3A] text-[#273B3A]"
                    />
                  ))}
                </div>
...
function FinalCTA() {
  ...
  return (
    <section className="relative py-28 sm:py-36 bg-[#0e0e0e] overflow-hidden">
      {/* Ambient glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#273B3A]/[0.03] rounded-full blur-[100px] pointer-events-none" />
          ...
          <div className="flex items-center gap-6">
            {["Twitter", "LinkedIn", "GitHub"].map((s) => (
              <a
                key={s}
                href="#"
                className="text-xs text-[#444444] hover:text-[#273B3A] transition-colors duration-300"
              >
                {s}
              </a>
            ))}
