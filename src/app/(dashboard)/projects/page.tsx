...
const tagStyles: Record<string, string> = {
  ...
  Internal: "bg-[rgba(156,74,41,0.15)] text-[#111827] border-[#E5E7EB]/20",
...
> = {
  ...
  done: { label: "Done", color: '#111827', border: "border-l-[#CDB49E]" },
};
    ...
    <div className="space-y-6 max-w-[1400px]">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="px-4 py-2.5 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] focus:outline-none focus:border-[#E5E7EB]/40 transition-colors cursor-pointer"
        >
            ...
            filtered.map((proj) => {
              ...
              return (
                <div
                  key={proj.id}
                  className={cn(
                    "bg-[#F8F9FA] border border-[#E5E7EB] border-l-4 rounded-xl p-5 hover:border-[#E5E7EB]/25 hover:shadow-lg hover:shadow-black/20 transition-all duration-200 cursor-pointer group",
                    sc.border
                  )}
                >
                  {/* Top: Star + Name */}
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-[#E5E7EB]">
                    <div className="flex items-center gap-3">
                      ...
                      {/* Milestones */}
                      <span className="flex items-center gap-1 text-xs text-[#111827]">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex -space-x-2">
                        {proj.assigned_to.slice(0, 2).map((name, idx) => (
                          <div
                            key={idx}
                            className="w-6 h-6 rounded-full bg-[#F8F9FA] border-2 border-[#E5E7EB] flex items-center justify-center"
                            title={name}
                          >
                        ...
                        {proj.assigned_to.length > 2 && (
                          <div className="w-6 h-6 rounded-full bg-[#F8F9FA] border-2 border-[#E5E7EB] flex items-center justify-center">
                            <span className="text-[8px] font-bold text-[#111827]">
                              +{proj.assigned_to.length - 2}
                            </span>
                          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#E5E7EB]">
                ...
                <th className="text-left px-4 py-4 text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
                  Project
                </th>
                <th className="text-left px-4 py-4 text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
                  Customer
                ...
                <th className="text-right px-4 py-4 text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
                  Status
                </th>
              </tr>
            </thead>
