        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#E6D4C7]">
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#273B3A] uppercase tracking-widest">PO #</th>
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#273B3A] uppercase tracking-widest">Vendor</th>
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#273B3A] uppercase tracking-widest">Date</th>
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#273B3A] uppercase tracking-widest">Expected Date</th>
            ...
            {filtered.length === 0 ? (
              <tr>
                <td colSpan={7} className="px-6 py-16 text-center text-[#273B3A] text-sm">
                  <Truck className="w-8 h-8 mx-auto mb-3 text-[#273B3A]/40" />
              ...
              filtered.map((order, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-[#273B3A]">{getVendorName(order.vendor_id)}</td>
                  <td className="px-6 py-4 text-sm text-[#273B3A]">{formatDate(order.order_date)}</td>
                  <td className="px-6 py-4 text-sm text-[#273B3A]">{order.expected_date ? formatDate(order.expected_date) : "—"}</td>
