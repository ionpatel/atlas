  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-medium text-[#FAFAFA] mb-1.5">Account Code</label>
          <input
            type="text"
            value={code}
        ...
        <div>
          <label className="block text-xs font-medium text-[#FAFAFA] mb-1.5">Type</label>
          <select
            value={type}
      ...
      <div>
        <label className="block text-xs font-medium text-[#FAFAFA] mb-1.5">Account Name</label>
        <input
          type="text"
          value={name}
      ...
      <div>
        <label className="block text-xs font-medium text-[#FAFAFA] mb-1.5">Opening Balance</label>
        <input
          type="number"
          value={balance}
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        ...
        <button
          type="submit"
          className="px-5 py-2.5 bg-[#161616] text-[#0A0A0A] rounded-lg text-sm font-semibold hover:bg-[#161616] transition-all duration-200"
        >
          Add Account
        </button>
      </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <label className="text-xs font-medium text-[#FAFAFA]">Journal Lines</label>
          <button
            type="button"
            onClick={addLine}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-[1fr_1fr_100px_100px_32px] gap-2 px-1">
            <span className="text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Account</span>
            <span className="text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Description</span>
            <span className="text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest text-right">Debit</span>
            <span className="text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest text-right">Credit</span>
            <span />
          </div>
          {lines.map((line, idx) => (
            <div key={idx} className="grid grid-cols-[1fr_1fr_100px_100px_32px] gap-2">
              <select
                ...
                className="px-3 py-2 bg-[#0A0A0A] border border-[#262626] rounded-lg text-xs text-[#FAFAFA] focus:outline-none focus:ring-2 focus:ring-[#CDB49E]/30 focus:border-[#262626]/50 transition-all duration-200"
              >
              ...
              <input
                ...
                className="px-3 py-2 bg-[#0A0A0A] border border-[#262626] rounded-lg text-xs text-[#FAFAFA] placeholder:text-[#FAFAFA] focus:outline-none focus:ring-2 focus:ring-[#CDB49E]/30 focus:border-[#262626]/50 transition-all duration-200"
              />
              <input
                type="number"
                value={line.debit}
                ...
                step="0.01"
                min="0"
                className="px-3 py-2 bg-[#0A0A0A] border border-[#262626] rounded-lg text-xs text-[#FAFAFA] text-right placeholder:text-[#FAFAFA] focus:outline-none focus:ring-2 focus:ring-[#CDB49E]/30 focus:border-[#262626]/50 transition-all duration-200"
              />
              <input
                type="number"
                value={line.credit}
              ...
              <button
                ...
                className="p-2 rounded-lg text-[#FAFAFA] hover:text-red-400 hover:bg-red-500/10 transition-all duration-200 disabled:opacity-30"
          ...
          {/* Totals */}
          <div className="grid grid-cols-[1fr_1fr_100px_100px_32px] gap-2 pt-2 border-t border-[#262626]">
            <span />
            <span className="text-xs font-semibold text-[#FAFAFA] text-right pr-1">Total</span>
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        ...
        <button
          type="submit"
          disabled={!isBalanced}
          className="px-5 py-2.5 bg-[#161616] text-[#0A0A0A] rounded-lg text-sm font-semibold hover:bg-[#161616] transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Create Entry
        </button>
      </div>
...
const bankCards = [
  { name: "Search 26,000+\nbanks", abbr: "🔍", bg: "bg-[rgba(156,74,41,0.15)]", text: "text-[#FAFAFA]" },
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl p-6">
        <div className="flex items-start justify-between mb-1">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-[#161616] text-[#0A0A0A] rounded-lg text-xs font-semibold hover:bg-[#161616] transition-all duration-200"
          >
        ...
        <div className="mt-5 space-y-3">
          {invoiceBarData.map((bar) => (
            <div key={bar.label} className="flex items-center gap-3">
              <span className="text-[11px] text-[#FAFAFA] w-20 text-right shrink-0">
                {bar.label}
              </span>
              <div className="flex-1 h-6 bg-[#0A0A0A] rounded-md overflow-hidden relative">
                <div
              ...
              <span className="text-[11px] font-medium text-[#FAFAFA] w-16 text-right shrink-0">
      ...
      <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl p-6">
        <div className="flex items-start justify-between mb-1">
          <div>
            <h3 className="text-base font-semibold text-[#FAFAFA]">Purchases</h3>
            <p className="text-xs text-[#FAFAFA] mt-0.5">
        ...
        <div
          ...
          className={`mt-4 flex flex-col items-center justify-center border-2 border-dashed rounded-xl py-8 transition-all duration-200 ${
            dragOver
              ...
              : "border-[#262626] bg-[#0A0A0A]/30 hover:border-[#262626]"
          }`}
        >
          <Upload
            className={`w-8 h-8 mb-2 transition-colors duration-200 ${
              dragOver ? "text-[#FAFAFA]" : "text-[#FAFAFA]"
            }`}
          />
          <span className="text-sm font-medium text-[#FAFAFA]">Drag & drop</span>
        </div>

        <div className="flex items-center gap-3 mt-3">
          <div className="flex-1 h-px bg-[#0A0A0A]" />
          <span className="text-[11px] text-[#FAFAFA]">or</span>
          <div className="flex-1 h-px bg-[#0A0A0A]" />
        </div>
        ...
        <div className="grid grid-cols-3 gap-2.5">
          {bankCards.map((bank, i) => (
            <button
              ...
              className="group flex flex-col items-center justify-center aspect-square rounded-xl border border-[#262626] hover:border-[#262626]/40 transition-all duration-200 hover:scale-[1.03]"
            ...
            >
              ...
              <span className="text-[10px] text-[#FAFAFA] text-center leading-tight px-1 whitespace-pre-line">
                {bank.name}
              </span>
            </button>
          ))}
      ...
      <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl p-6">
        ...
        <div className="flex flex-col items-center justify-center py-10">
          <div className="w-14 h-14 rounded-2xl bg-[#0A0A0A] border border-[#262626] flex items-center justify-center mb-4">
            <MonitorSmartphone className="w-7 h-7 text-[#FAFAFA]" />
          </div>
          <p className="text-sm font-medium text-[#FAFAFA] mb-1">Coming Soon</p>
          <p className="text-xs text-[#FAFAFA] text-center max-w-xs mb-5">
            Accept in-person payments, track cash registers, and manage retail operations from one place.
          </p>
          <button
            disabled
            className="px-5 py-2.5 bg-[#0A0A0A] text-[#FAFAFA] rounded-lg text-sm font-medium border border-[#262626] cursor-not-allowed"
          >
            Set up POS
          </button>
        </div>
...
function InvoiceFormInline({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-medium text-[#FAFAFA] mb-1.5">Customer Name</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-xs font-medium text-[#FAFAFA] mb-1.5">Amount</label>
          <input
            type="number"
            placeholder="0.00"
            step="0.01"
  ...
  return (
    <div className="space-y-6">
      ...
      {accountTypes.map((type) => {
        ...
        return (
          <div key={type} className="bg-[#0A0A0A] border border-[#262626] rounded-xl overflow-hidden">
            <div className="px-6 py-3 border-b border-[#262626] bg-[#0A0A0A]">
              <h3 className="text-xs font-semibold text-[#FAFAFA] uppercase tracking-widest">
                {typeLabels[type]}
              </h3>
            </div>
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#262626]">
                  <th className="text-left px-6 py-3 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Code</th>
                  <th className="text-left px-6 py-3 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Name</th>
                  <th className="text-left px-6 py-3 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Type</th>
                  <th className="text-right px-6 py-3 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Balance</th>
                  <th className="text-right px-6 py-3 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest w-16"></th>
                </tr>
              </thead>
              <tbody>
                {typeAccounts.map((account, i) => {
                  ...
                  return (
                    <tr
                      key={account.id}
                      className={`hover:bg-[#0A0A0A] transition-colors duration-150 border-b border-[#262626]/50 last:border-0 ${
                        i % 2 === 1 ? "bg-[#0A0A0A]/40" : ""
                      }`}
                    >
                      <td className="px-6 py-3.5 text-sm font-mono text-[#FAFAFA]">{account.code}</td>
                      <td className="px-6 py-3.5 text-sm font-medium text-[#FAFAFA]">{account.name}</td>
      ...
      {filtered.length === 0 && (
        <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl px-6 py-16 text-center">
          <Calculator className="w-8 h-8 mx-auto mb-3 text-[#FAFAFA]/40" />
          <p className="text-[#FAFAFA] text-sm">No accounts found</p>
        </div>
      )}
    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl overflow-hidden">
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#262626]">
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest w-8"></th>
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Entry #</th>
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Date</th>
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Description</th>
...
function JournalEntryRow({
  ...
  return (
    <>
      <tr
        onClick={onToggle}
        className={`hover:bg-[#0A0A0A] transition-colors duration-150 cursor-pointer border-b border-[#262626]/50 ${
          index % 2 === 1 ? "bg-[#0A0A0A]/40" : ""
        } ${expanded ? "bg-[#0A0A0A]" : ""}`}
      >
        <td className="pl-6 py-4">
          {expanded ? (
            <ChevronDown className="w-3.5 h-3.5 text-[#FAFAFA]" />
          ) : (
            <ChevronRight className="w-3.5 h-3.5 text-[#FAFAFA]" />
          )}
        </td>
        <td className="px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-[#FAFAFA] font-mono">{entry.entry_number}</span>
          </div>
        </td>
        <td className="px-6 py-4 text-sm text-[#FAFAFA]">{formatDate(entry.date)}</td>
        <td className="px-6 py-4 text-sm text-[#FAFAFA]">{entry.description}</td>
        <td className="px-6 py-4 text-sm text-right font-semibold text-[#FAFAFA]">
          ...
          <td colSpan={7} className="px-12 py-4">
            <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl overflow-hidden">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[#262626]">
                    <th className="text-left px-5 py-2.5 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Account</th>
                    <th className="text-left px-5 py-2.5 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Description</th>
                    <th className="text-right px-5 py-2.5 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Debit</th>
                    <th className="text-right px-5 py-2.5 text-[10px] font-semibold text-[#FAFAFA] uppercase tracking-widest">Credit</th>
                  </tr>
                </thead>
                <tbody>
                  {entry.lines.map((line) => (
                    <tr key={line.id} className="border-b border-[#262626]/50 last:border-0">
                      <td className="px-5 py-2.5 text-xs font-medium text-[#FAFAFA]">{line.account_name}</td>
                      <td className="px-5 py-2.5 text-xs text-[#FAFAFA]">{line.description}</td>
                      <td className="px-5 py-2.5 text-xs text-right font-mono text-[#FAFAFA]">
...
function ReportsTab() {
  ...
  return (
    <div className="space-y-6">
      {/* P&L Statement */}
      <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl p-6">
        <h3 className="text-base font-semibold text-[#FAFAFA] mb-5">Profit & Loss Statement</h3>
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-2">
              {pnl.revenue.map((item) => (
                <div key={item.account.id} className="flex items-center justify-between pl-4">
                  <span className="text-sm text-[#FAFAFA]">{item.account.name}</span>
                  <span className="text-sm font-medium text-[#FAFAFA]">{formatCurrency(item.amount)}</span>
                </div>
              ))}
              <div className="flex items-center justify-between pl-4 pt-1 border-t border-[#262626]">
                <span className="text-sm font-semibold text-[#FAFAFA]">Total Revenue</span>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between pl-4 pt-1 border-t border-[#262626]">
                <span className="text-sm font-semibold text-[#FAFAFA]">Total Expenses</span>
          ...
          {/* Net Income */}
          <div className="border-t-2 border-[#262626] pt-4 flex items-center justify-between">
            <span className="text-base font-bold text-[#FAFAFA]">Net Income</span>
      ...
      {/* Balance Sheet */}
      <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl p-6">
        <h3 className="text-base font-semibold text-[#FAFAFA] mb-5">Balance Sheet</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between pl-4 pt-1 border-t border-[#262626]">
                <span className="text-sm font-bold text-[#FAFAFA]">Total Assets</span>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between pl-4 pt-1 border-t border-[#262626]">
                  <span className="text-sm font-semibold text-[#FAFAFA]">Total Liabilities</span>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between pl-4 pt-1 border-t border-[#262626]">
                  <span className="text-sm font-semibold text-[#FAFAFA]">Total Equity</span>
                  <span className="text-sm font-bold text-violet-400">{formatCurrency(bs.totalEquity)}</span>
                </div>
              </div>
            </div>
            <div className="border-t-2 border-[#262626] pt-3 flex items-center justify-between">
              <span className="text-sm font-bold text-[#FAFAFA]">Liabilities + Equity</span>
      ...
      {/* Tax Report */}
      <div className="bg-[#0A0A0A] border border-[#262626] rounded-xl p-6">
        <h3 className="text-base font-semibold text-[#FAFAFA] mb-5">Tax Report (GST/HST)</h3>

        <div className="space-y-4">
          {/* Tax Rates */}
          <div className="grid grid-cols-3 gap-4">
            {taxConfig.map((t) => (
              <div key={t.id} className="bg-[#0A0A0A] border border-[#262626] rounded-lg p-4 text-center">
                <p className="text-xs text-[#FAFAFA] mb-1">{t.name}</p>
                <p className="text-lg font-bold text-[#FAFAFA]">{(t.rate * 100).toFixed(0)}%</p>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center justify-between">
              <span className="text-sm text-[#FAFAFA]">GST/HST Collected on Sales</span>
              <span className="text-sm font-semibold text-[#FAFAFA]">{formatCurrency(tax.collected)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-[#FAFAFA]">Input Tax Credits (ITC) Paid</span>
              <span className="text-sm font-semibold text-[#FAFAFA]">{formatCurrency(tax.paid)}</span>
            </div>
            <div className="border-t-2 border-[#262626] pt-3 flex items-center justify-between">
              <span className="text-sm font-bold text-[#FAFAFA]">Net Tax Owing</span>
...
export default function AccountingPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1400px]">
      ...
      {/* Tabs */}
      <div className="flex items-center gap-1 bg-[#0A0A0A] border border-[#262626] rounded-xl p-1.5">
        {tabs.map((tab) => (
          <button
            key={tab.id}
