...
function RoleBadge({ role }: { role: string }) {
  const styles: Record<string, string> = {
    owner: "bg-[rgba(156,74,41,0.15)] text-[#111827] border-[#E5E7EB]/20",
    admin: "bg-violet-500/10 text-violet-400 border-violet-500/20",
    manager: "bg-blue-500/10 text-blue-400 border-blue-500/20",
    staff: "bg-[#F8F9FA] text-[#111827] border-[#E5E7EB]",
  };
...
function ToggleSwitch({
  ...
  return (
    ...
    >
      {enabled ? (
        <ToggleRight className="w-8 h-8 text-[#111827]" />
      ) : (
        <ToggleLeft className="w-8 h-8 text-[#111827]" />
      )}
    </button>
  );
}
...
function GeneralSection() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-lg font-semibold text-[#111827]">General</h2>
      ...
      <div>
        ...
        <div className="flex items-center gap-5">
          <div className="w-20 h-20 rounded-xl bg-[#F8F9FA] border-2 border-dashed border-[#E5E7EB] flex items-center justify-center">
            <span className="text-2xl font-bold text-[#111827]">A</span>
          </div>
          <button className="flex items-center gap-2 px-4 py-2.5 border border-[#E5E7EB] rounded-lg text-sm text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] focus:outline-none focus:border-[#E5E7EB]/40 transition-colors"
          />
        </div>
        <div>
          <label className="block text-xs font-medium text-[#111827] uppercase tracking-wider mb-2">
      ...
      <div className="pt-4 border-t border-[#E5E7EB]">
        <button className="px-5 py-2.5 bg-white text-white rounded-lg text-sm font-semibold hover:bg-white transition-all duration-200">
          Save Changes
        </button>
      </div>
    </div>
      ...
      <div className="bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl overflow-hidden">
        {mockMembers.map((member, i) => (
          <div
            key={member.email}
            className={cn(
              "px-6 py-4 flex items-center justify-between transition-colors hover:bg-[#F8F9FA]/50",
              i < mockMembers.length - 1 && "border-b border-[#E5E7EB]/50"
            )}
          >
...
function BillingSection() {
  return (
    <div className="space-y-6">
      ...
      {/* Current plan */}
      <div className="bg-[#F8F9FA] border border-[#E5E7EB]/20 rounded-xl p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="px-2 py-0.5 rounded-full bg-[rgba(156,74,41,0.15)] text-[#111827] text-[10px] font-semibold uppercase tracking-wider">
                Current
              </span>
            </div>
          ...
          <button className="px-4 py-2.5 border border-[#E5E7EB] rounded-lg text-sm text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all duration-200">
            Change Plan
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          return (
            ...
            >
              <p className="text-xs text-[#111827] uppercase tracking-wider mb-3">
                {stat.label}
              </p>
              ...
              <div className="mt-3 h-1.5 bg-[#F8F9FA] rounded-full overflow-hidden">
                <div
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <div
            key={plan.name}
            className={cn(
              "bg-[#F8F9FA] border rounded-xl p-5",
              plan.current
                ? "border-[#E5E7EB]/30"
                : "border-[#E5E7EB]"
            )}
          >
            ...
            <ul className="mt-4 space-y-2">
              {plan.features.map((f) => (
                <li
                  key={f}
                  className="flex items-center gap-2 text-xs text-[#111827]"
                >
            ...
            {plan.current && (
              <div className="mt-4 text-center text-[11px] font-medium text-[#111827]">
                Current plan
              </div>
            )}
          </div>
...
function ModulesSection() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-[#111827]">Modules</h2>
        <p className="text-sm text-[#111827] mt-1">
        ...
        {modules.map((mod, i) => (
          <div
            ...
            className={cn(
              ...
              i < modules.length - 1 && "border-b border-[#E5E7EB]/50"
            )}
          >
            <div>
              <p className="text-sm font-medium text-[#111827]">
...
function IntegrationsSection() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-[#111827]">Integrations</h2>
        <p className="text-sm text-[#111827] mt-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {mockIntegrations.map((integration) => (
          <div
            ...
            className="bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl p-5 flex items-start justify-between hover:border-[#E5E7EB]/20 transition-all duration-200"
          >
            ...
            <button className="flex items-center gap-1.5 px-3 py-1.5 border border-[#E5E7EB] rounded-lg text-[11px] font-medium text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all duration-200 flex-shrink-0 ml-4">
              Connect
...
function TaxSection() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-lg font-semibold text-[#111827]">Tax Settings</h2>
        <p className="text-sm text-[#111827] mt-1">
      ...
      <div>
        ...
        <input
          ...
          className="w-full max-w-md px-4 py-2.5 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#E5E7EB]/40 transition-colors"
        />
      </div>
          ...
          {taxRates.map((tax, i) => (
            <div
              ...
              className={cn(
                ...
                i < taxRates.length - 1 && "border-b border-[#E5E7EB]/50"
              )}
            >
              ...
              <input
                ...
                className="w-52 px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-xs text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#E5E7EB]/40 transition-colors"
              />
            </div>
          ))}
        </div>
...
function CompanySection() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-lg font-semibold text-[#111827]">Company Profile</h2>
        <p className="text-sm text-[#111827] mt-1">
...
function BrandingSection() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-lg font-semibold text-[#111827]">Branding</h2>
        <p className="text-sm text-[#111827] mt-1">
      ...
      <div className="bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            <label className="block text-xs font-medium text-[#111827] uppercase tracking-wider mb-3">
              Company Logo
            </label>
            <div className="flex items-center gap-4">
              <div className="w-24 h-24 rounded-xl bg-[#F8F9FA] border-2 border-dashed border-[#E5E7EB] flex items-center justify-center">
                {logoUrl ? (
                  <img src={logoUrl} alt="Logo" className="w-full h-full object-contain rounded-xl" />
                ) : (
                  <span className="text-3xl font-bold text-[#111827]">A</span>
                )}
              </div>
              <div className="flex flex-col gap-2">
                <button className="flex items-center gap-2 px-4 py-2 border border-[#E5E7EB] rounded-lg text-xs text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-lg bg-[#F8F9FA] border-2 border-dashed border-[#E5E7EB] flex items-center justify-center">
                {faviconUrl ? (
                  <img src={faviconUrl} alt="Favicon" className="w-full h-full object-contain rounded-lg" />
                ) : (
                  <span className="text-lg font-bold text-[#111827]">A</span>
                )}
              </div>
              <div className="flex flex-col gap-2">
                <button className="flex items-center gap-2 px-4 py-2 border border-[#E5E7EB] rounded-lg text-xs text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all">
            ...
            <button
              ...
              className={cn(
                ...
                theme === t.id
                  ...
                  : "bg-[#F8F9FA] border-[#E5E7EB] text-[#374151] hover:text-[#111827] hover:border-[#E5E7EB]"
              )}
            >
      ...
      <div className="bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl p-6">
        ...
        <div className="space-y-4">
            ...
            {presetColors.map((color) => (
              <button
                ...
                className={cn(
                  ...
                  primaryColor === color && "ring-2 ring-offset-2 ring-offset-white ring-white/30"
                )}
          ...
          <div className="flex items-center gap-3">
            <div
              className="w-12 h-12 rounded-lg border border-[#E5E7EB]"
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] font-mono focus:outline-none focus:border-[#E5E7EB]/40 transition-colors"
                />
                <button className="p-2 border border-[#E5E7EB] rounded-lg text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all">
          ...
          <div className="mt-4 p-4 bg-[#F8F9FA] rounded-lg">
            <p className="text-xs text-[#111827] mb-3">Preview</p>
            <div className="flex items-center gap-3">
              <button
...
function NotificationsSection() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-lg font-semibold text-[#111827]">Email Notifications</h2>
        <p className="text-sm text-[#111827] mt-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <div
            key={item.label}
            className="bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl p-4 flex items-center gap-3"
          >
      ...
      <Link
        ...
        className="flex items-center justify-between p-6 bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl hover:border-[#E5E7EB]/30 transition-all group"
      >
        <div className="flex items-center gap-4">
        ...
        <ChevronRight className="w-5 h-5 text-[#111827] group-hover:text-[#111827] transition-colors" />
      </Link>
    </div>
  );
}
...
function AuditLogsRedirect() {
  return (
    <div className="flex flex-col items-center justify-center py-12">
      <p className="text-[#111827] text-sm">Redirecting to Audit Logs...</p>
    </div>
  );
}
            ...
            if (hasHref) {
              return (
                <Link
                  ...
                  className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-[13px] font-medium transition-all duration-200 text-left text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA]"
                >
