...
function ModuleBadge({ tableName }: { tableName: string }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#F8F9FA] text-[#111827] text-[11px] font-medium border border-[#E5E7EB]">
      <Icon className="w-3 h-3" />
      {moduleName}
    </span>
  );
...
function AuditLogRow({ log }: { log: AuditLog }) {
  ...
  return (
    <div className="border-b border-[#E5E7EB]/50 last:border-b-0">
      {/* Main Row */}
      <div
        className={cn(
          "px-6 py-4 flex items-center gap-4 transition-colors",
          hasChanges && "cursor-pointer hover:bg-[#F8F9FA]/50"
        )}
      ...
      >
        ...
        <div className="w-28 flex-shrink-0">
          <p className="text-sm text-[#111827]">{formatDate(log.created_at)}</p>
        ...
        <div className="w-40 flex-shrink-0">
          ...
          <p className="text-[10px] text-[#111827] truncate mt-0.5">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm text-[#111827] font-mono truncate">
      ...
      {expanded && hasChanges && (
        <div className="px-6 pb-4 ml-11">
          <div className="bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg p-4">
            <p className="text-[10px] text-[#111827] uppercase tracking-wider mb-3">
              Changes
            </p>
            ...
            <div className="space-y-2">
              ...
              {diff.changed.map((field) => (
                ...
                >
                  <span className="w-32 text-[#111827] font-medium truncate">
                    {field}
                  </span>
            ...
            {/* Metadata */}
            <div className="mt-4 pt-3 border-t border-[#E5E7EB] flex items-center gap-6 text-[10px] text-[#111827]">
    ...
    <div className="flex items-center gap-3 flex-wrap">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-9 pr-4 py-2 w-56 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:border-[#E5E7EB]/40 transition-colors"
        />
      </div>
      ...
      <select
        ...
        className="px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] focus:outline-none focus:border-[#E5E7EB]/40 transition-colors"
      >
      ...
      {hasFilters && (
        <button
          onClick={onReset}
          className="flex items-center gap-1.5 px-3 py-2 text-sm text-[#374151] hover:text-[#111827] transition-colors"
        >
    ...
    <div className="max-w-[1400px]">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[#111827] text-sm mt-0.5">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 border border-[#E5E7EB] rounded-lg text-sm text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all duration-200"
        >
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {[
          { label: "Total Logs", value: totalCount, color: "text-[#111827]" },
          {
            label: "Creates",
          ...
          >
            <p className="text-[10px] text-[#111827] uppercase tracking-wider mb-1">
              {stat.label}
            </p>
      ...
      <div className="bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl overflow-hidden">
        {/* Header */}
        <div className="px-6 py-3 bg-[#F8F9FA] border-b border-[#E5E7EB] flex items-center gap-4 text-[10px] text-[#111827] uppercase tracking-wider">
          <div className="w-5 flex-shrink-0" />
        ...
        {loading && (
          <div className="px-6 py-12 text-center">
            <RefreshCw className="w-6 h-6 text-[#111827] animate-spin mx-auto mb-3" />
            <p className="text-sm text-[#111827]">Loading audit logs...</p>
          </div>
        )}
        ...
        {!loading && filteredLogs.length === 0 && (
          <div className="px-6 py-12 text-center">
            <History className="w-8 h-8 text-[#111827] mx-auto mb-3" />
            <p className="text-sm text-[#111827]">No audit logs found</p>
      ...
      {filteredLogs.length > 0 && (
        <div className="mt-4 flex items-center justify-between text-xs text-[#111827]">
          <span>
