        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#2a2a2a]">
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#888888] uppercase tracking-widest">Order #</th>
              ...
              <th className="text-left px-6 py-4 text-[10px] font-semibold text-[#888888] uppercase tracking-widest">Delivery Date</th>
            ...
            {filtered.length === 0 ? (
              <tr>
                <td colSpan={7} className="px-6 py-16 text-center text-[#888888] text-sm">
                  <ShoppingCart className="w-8 h-8 mx-auto mb-3 text-[#888888]/40" />
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-[#3a3028] flex items-center justify-center flex-shrink-0">
                        <ShoppingCart className="w-3.5 h-3.5 text-[#CDB49E]" />
                      </div>
                      <span className="text-sm font-medium text-[#f5f0eb] font-mono">{order.order_number}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 text-sm text-[#f5f0eb]">{getContactName(order.contact_id)}</td>
                  <td className="px-6 py-4 text-sm text-[#888888]">{formatDate(order.order_date)}</td>
                  <td className="px-6 py-4 text-sm text-[#888888]">{order.delivery_date ? formatDate(order.delivery_date) : "—"}</td>
