  ...
  return (
    <div className="space-y-4">
            ...
            <>
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 bg-white text-white rounded-lg text-xs font-medium hover:bg-white transition-all"
                >
                ...
                {showAddMenu && addableWidgets.length > 0 && (
                  <>
                    ...
                    />
                    <div className="absolute left-0 top-full mt-1 w-56 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg shadow-xl z-20 py-1">
                      {addableWidgets.map((w) => (
                        <button
                          key={w.type}
                          onClick={() => handleAddWidget(w.type)}
                          className="w-full text-left px-4 py-2.5 text-xs text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-colors"
                        >
                          {w.title}
                        </button>
                      ))}
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 border border-[#E5E7EB] rounded-lg text-xs text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all"
              >
        ...
        <button
          ...
          className={cn(
            ...
            editMode
              ...
              : "border border-[#E5E7EB] text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA]"
          )}
        >
            ...
            {editMode && (
              <div className="absolute inset-0 z-10 pointer-events-none">
                ...
                <div className="absolute top-2 left-2 pointer-events-auto">
                  <button className="p-1.5 rounded bg-[#F8F9FA] border border-[#E5E7EB] text-[#374151] hover:text-[#111827] cursor-grab active:cursor-grabbing">
                ...
                <div className="absolute top-2 right-2 flex items-center gap-1 pointer-events-auto">
                  ...
                  <select
                    ...
                    className="px-2 py-1.5 text-[10px] bg-[#F8F9FA] border border-[#E5E7EB] rounded text-[#111827] focus:outline-none cursor-pointer"
                  >
                ...
                {/* Edit Mode Border */}
                <div className="absolute inset-0 border-2 border-dashed border-[#E5E7EB]/30 rounded-xl" />
              </div>
            )}
      ...
      {editMode && hiddenWidgets.length > 0 && (
        <div className="mt-6 p-4 bg-[#F8F9FA] border border-[#E5E7EB] rounded-xl">
          <p className="text-xs font-medium text-[#111827] mb-3 flex items-center gap-2">
          ...
          <div className="flex flex-wrap gap-2">
            {hiddenWidgets.map((widget) => (
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-xs text-[#374151] hover:text-[#111827] hover:border-[#E5E7EB]/30 transition-all"
              >
