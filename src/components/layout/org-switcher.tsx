  ...
  return (
    <div className="relative">
      <button
        ...
        className={cn(
          "w-full flex items-center gap-3 p-3 rounded-xl bg-[#1a1a1a] border border-[#2a2a2a] hover:border-[#3a3a3a] transition-all",
      ...
      {isOpen && (
        <>
          ...
          <div
            className={cn(
              "absolute z-50 w-64 mt-2 bg-[#111111] border border-[#2a2a2a] rounded-xl shadow-2xl overflow-hidden",
              collapsed ? "left-full ml-2 top-0" : "left-0 top-full"
            )}
          >
            <div className="p-2 border-b border-[#2a2a2a]">
              <p className="px-2 py-1 text-[10px] font-medium text-[#555555] uppercase tracking-wider">
                Your Organizations
              </p>
            </div>
            ...
            <div className="max-h-64 overflow-y-auto py-1">
              {organizations.map((org) => (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center gap-3 px-3 py-2.5 hover:bg-[#1a1a1a] transition-colors",
                    org.id === currentOrg.id && "bg-[#1a1a1a]"
                  )}
                >
                  <div className="w-8 h-8 rounded-lg bg-[#222222] flex items-center justify-center flex-shrink-0">
                  ...
                  {org.id === currentOrg.id && (
                    <Check className="w-4 h-4 text-[#CDB49E]" />
                  )}
                </button>
              ))}
            </div>
            ...
            <div className="border-t border-[#2a2a2a] p-2">
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 text-sm text-[#888888] hover:text-[#f5f0eb] hover:bg-[#1a1a1a] rounded-lg transition-colors"
              >
              ...
              {onCreateNew && (
                <button
                  ...
                  className="w-full flex items-center gap-2 px-3 py-2 text-sm text-[#CDB49E] hover:bg-[#CDB49E]/10 rounded-lg transition-colors"
                >
