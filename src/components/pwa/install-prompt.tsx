  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 z-50 animate-in slide-in-from-bottom-4 duration-300">
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl shadow-2xl shadow-black/50 overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#273B3A]/20 to-transparent px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-lg bg-[#273B3A]/20">
              <Download className="h-4 w-4 text-[#273B3A]" />
            </div>
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-2 mb-4">
                <div className="flex flex-col items-center gap-1 p-2 bg-neutral-800/50 rounded-lg">
                  <Wifi className="h-4 w-4 text-[#273B3A]" />
                ...
                <div className="flex flex-col items-center gap-1 p-2 bg-neutral-800/50 rounded-lg">
                  <Bell className="h-4 w-4 text-[#273B3A]" />
              ...
              <div className="flex gap-2">
                ...
                <Button
                  className="flex-1 bg-[#273B3A] hover:bg-[#273B3A]/90 text-black"
