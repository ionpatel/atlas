...
const inputClass =
  "w-full px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] placeholder:text-[#111827] focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-[#E5E7EB]/50 transition-all duration-200";

const labelClass = "block text-xs font-medium text-[#111827] mb-1.5";
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          {/* Type Toggle */}
          <div className="flex items-center bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg p-0.5">
            <button
              type="button"
          ...
          <span className="text-sm font-mono text-[#111827]">{billNumber}</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <span
            className={`px-2.5 py-1 rounded-full text-[11px] font-medium border ${
              status === "draft"
                ? "bg-[rgba(156,74,41,0.15)] text-[#111827] border-[#E5E7EB]/30"
                : "bg-[#F8F9FA] text-[#111827] border-[#E5E7EB]"
            }`}
          >
            Draft
          </span>
          <div className="w-6 h-px bg-[#F8F9FA]" />
          <span
            className={`px-2.5 py-1 rounded-full text-[11px] font-medium border ${
              status === "posted"
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="px-5 py-2 bg-white text-white rounded-lg text-sm font-semibold hover:bg-white transition-all duration-200"
        >
          Confirm
        </button>
        <button
          type="button"
          onClick={onCancel}
          className="px-5 py-2 border border-[#E5E7EB] rounded-lg text-sm text-[#374151] hover:text-[#111827] hover:bg-[#F8F9FA] transition-all duration-200"
        >
          Cancel
        </button>
      </div>
        ...
        <div className="space-y-4">
          <div className="relative">
            ...
            {showVendorDropdown && filteredVendors.length > 0 && (
              <div className="absolute z-20 top-full left-0 right-0 mt-1 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg shadow-xl max-h-40 overflow-y-auto">
                {filteredVendors.map((v) => (
                  <button
                    key={v.id}
                    type="button"
                    onMouseDown={() => selectVendor(v.id, v.name)}
                    className="w-full text-left px-3 py-2 text-sm text-[#111827] hover:bg-[#F8F9FA] transition-colors"
                  >
                    {v.name}
                    {v.company && (
                      <span className="text-[#111827] ml-2">({v.company})</span>
                    )}
                  </button>
                ))}
              </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className={labelClass}>
              ...
              <button
                type="button"
                className="text-[#374151] hover:text-[#111827] text-[10px] ml-1"
              >
                or Payment Terms
              </button>
            </label>
      ...
      {activeTab === "lines" && (
        <div>
          ...
          <div className="grid grid-cols-[2fr_1.5fr_80px_100px_70px_100px_32px] gap-2 px-1 pb-2">
            <span className="text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
              Label
            </span>
            <span className="text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
              Account
            </span>
            <span className="text-[10px] font-semibold text-[#111827] uppercase tracking-widest text-right">
              Qty
            </span>
            <span className="text-[10px] font-semibold text-[#111827] uppercase tracking-widest text-right">
              Price
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm font-semibold text-[#111827] placeholder:text-[#111827] focus:outline-none focus:ring-2 focus:ring-red-200 transition-all duration-200"
                    />
                    <button
                      type="button"
                      onClick={() => removeLine(line.key)}
                      className="p-2 text-[#111827] hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-all duration-200"
                    >
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="px-3 py-2 bg-[#F8F9FA] border border-dashed border-[#E5E7EB] rounded-lg text-sm italic text-[#111827] placeholder:text-[#111827] focus:outline-none focus:ring-2 focus:ring-red-200 transition-all duration-200"
                    />
                    <button
                      type="button"
                      onClick={() => removeLine(line.key)}
              ...
              return (
                ...
                >
                  <input
                    ...
                    className="px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] placeholder:text-[#111827] focus:outline-none focus:ring-2 focus:ring-red-200 transition-all duration-200"
                  />
                  <select
                    ...
                    className="px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] focus:outline-none focus:ring-2 focus:ring-red-200 transition-all duration-200"
                  >
                  ...
                  <input
                    ...
                    className="px-3 py-2 bg-[#F8F9FA] border border-[#E5E7EB] rounded-lg text-sm text-[#111827] text-right focus:outline-none focus:ring-2 focus:ring-red-200 transition-all duration-200"
                  />
                  <input
                    type="number"
                    step="0.01"
          ...
          <div className="flex items-center gap-4 mt-3">
            <button
              type="button"
              onClick={addLine}
              className="flex items-center gap-1.5 text-xs text-[#374151] hover:text-[#111827] font-medium transition-colors"
            >
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#E5E7EB]">
                <th className="text-left px-5 py-3 text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
                  Account
                </th>
                <th className="text-left px-5 py-3 text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
                  Label
                </th>
                <th className="text-right px-5 py-3 text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
                  Debit
                </th>
                <th className="text-right px-5 py-3 text-[10px] font-semibold text-[#111827] uppercase tracking-widest">
                  Credit
            ...
            <tbody>
              {journalItems.length === 0 ? (
                <tr>
                  <td
                    colSpan={4}
                    className="px-5 py-8 text-center text-sm text-[#111827]"
                  >
                    <FileText className="w-6 h-6 mx-auto mb-2 text-[#111827]" />
                ...
                journalItems.map((item, i) => (
                  ...
                  >
                    <td className="px-5 py-2.5 text-sm text-[#111827]">
                      {item.account}
                    </td>
                    <td className="px-5 py-2.5 text-sm text-[#111827]">
                      {item.label}
                    </td>
                    <td className="px-5 py-2.5 text-sm text-right font-mono text-[#111827]">
